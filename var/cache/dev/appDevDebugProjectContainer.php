...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_elastica.provider.app.user' => 'getFosElastica_Provider_App_UserService',
    ...
    {
        $this->services['fos_elastica.client.default'] = $instance = new \FOS\ElasticaBundle\Elastica\Client(array('connections' => array(0 => array('host' => 'localhost', 'port' => 9200, 'logger' => 'fos_elastica.logger', 'compression' => false, 'headers' => array(), 'retryOnConflict' => 0)), 'connectionStrategy' => 'Simple'), '');
    ...
    {
        return $this->services['fos_elastica.config_manager'] = new \FOS\ElasticaBundle\Configuration\ConfigManager(array(0 => new \FOS\ElasticaBundle\Configuration\Source\ContainerSource(array('app' => array('elasticsearch_name' => 'app', 'reference' => ${($_ = isset($this->services['fos_elastica.index.app']) ? $this->services['fos_elastica.index.app'] : $this->get('fos_elastica.index.app')) && false ?: '_'}, 'name' => 'app', 'settings' => array(), 'type_prototype' => array(), 'use_alias' => false, 'types' => array('user' => array('name' => 'user', 'mapping' => array('dynamic_templates' => array(), 'properties' => array('firstName' => array(), 'lastName' => array())), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'appBundle\\Entity\\User', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder'), 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'finder' => array(), 'identifier' => 'id', 'elastica_to_model_transformer' => array('hints' => array(), 'hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array(), 'persister' => array()), 'serializer' => array('groups' => array(), 'serialize_null' => false), 'index_analyzer' => NULL, 'search_analyzer' => NULL, 'dynamic' => NULL, 'date_detection' => NULL, 'dynamic_date_formats' => array(), 'numeric_detection' => NULL))))))));
    }
    ...
    {
        $this->services['fos_elastica.manager.orm'] = $instance = new \FOS\ElasticaBundle\Doctrine\RepositoryManager(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, ${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'});

        $instance->addEntity('appBundle\\Entity\\User', ${($_ = isset($this->services['fos_elastica.finder.app.user']) ? $this->services['fos_elastica.finder.app.user'] : $this->get('fos_elastica.finder.app.user')) && false ?: '_'});
    ...
    /**
     * Gets the public 'fos_elastica.provider.app.user' shared service.
     *
     * @return \FOS\ElasticaBundle\Doctrine\ORM\Provider
     */
    protected function getFosElastica_Provider_App_UserService()
    {
        return $this->services['fos_elastica.provider.app.user'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider(${($_ = isset($this->services['fos_elastica.object_persister.app.user']) ? $this->services['fos_elastica.object_persister.app.user'] : $this->get('fos_elastica.object_persister.app.user')) && false ?: '_'}, ${($_ = isset($this->services['fos_elastica.indexable']) ? $this->services['fos_elastica.indexable'] : $this->get('fos_elastica.indexable')) && false ?: '_'}, 'appBundle\\Entity\\User', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'app', 'typeName' => 'user'), ${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, ${($_ = isset($this->services['fos_elastica.slice_fetcher.orm']) ? $this->services['fos_elastica.slice_fetcher.orm'] : $this->get('fos_elastica.slice_fetcher.orm')) && false ?: '_'});
    }
    ...
    protected function getFosElastica_ProviderRegistryService()
    {
        ...
        $instance->addProvider('app', 'user', 'fos_elastica.provider.app.user');
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eMFziUsmTO', 0, 'znuBFWCVQg0Y6jH4NuZ+qD', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('79KfMjHJ0W', 0, 'znuBFWCVQg0Y6jH4NuZ+qD', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lG3+DBfEpD', 0, 'znuBFWCVQg0Y6jH4NuZ+qD', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a5cb05ee0e4f7.81327738');
    }

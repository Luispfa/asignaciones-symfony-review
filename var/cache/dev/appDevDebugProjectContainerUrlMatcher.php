...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/user')) {
            ...
            if (0 === strpos($pathinfo, '/user/create')) {
                // user_create
                ...
                // redirect-add
                if ('/user/create' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\UserController::addAction',  'path' => '/user/add',  'permanent' => true,  '_route' => 'redirect-add',);
                }
            ...
            if (0 === strpos($pathinfo, '/user/update')) {
                // user_update
                if (preg_match('#^/user/update/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                // redirect-edit
                if (preg_match('#^/user/update/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'redirect-edit')), array (  '_controller' => 'AppBundle\\Controller\\UserController::editAction',  'path' => '/user/edit/{id}',  'permanent' => true,));
                }
            ...
            if (0 === strpos($pathinfo, '/user/view') && preg_match('#^/user/view/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_view')), array (  '_controller' => 'AppBundle\\Controller\\UserController::viewAction',));
            }
